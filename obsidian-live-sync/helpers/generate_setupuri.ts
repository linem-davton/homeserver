...
async function main() {
  const conf = {
    couchDB_URI: `${Deno.env.get("COUCHDB_HOST")}`,
    couchDB_USER: `${Deno.env.get("COUCHDB_ADMIN_USERNAME")}`,
    couchDB_PASSWORD: `${Deno.env.get("COUCHDB_ADMIN_PASSWORD")}`,
    couchDB_DBNAME: `${Deno.env.get("COUCHDB_NAME")}`,
    syncOnStart: true,
    gcDelay: 0,
    periodicReplication: true,
    syncOnFileOpen: true,
    encrypt: true,
    passphrase: `${Deno.env.get("E2E_PASSPHRASE")}`,
